...
name_entry = Entry(name_frame, bg = 'light cyan', Command = load())
...
number_entry = Entry(number_frame, bg = 'light cyan', Command = load())
...
year_entry = Entry(year_frame, bg = 'light cyan', Command = load())
...
city_entry = Entry(city_frame, bg = 'light cyan', Command = load())
...
email_entry = Entry(email_frame, bg = 'light cyan', Command = load())
...
save_frame.pack()
save_bottun = Button(save_frame, text = 'Save', width=7, height=2, bg = 'dark grey', command= save())
